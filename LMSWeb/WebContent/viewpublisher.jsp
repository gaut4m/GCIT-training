...
<%
	...
	pubs = (List<Publisher>)admin.getService("pubs","",1,10);
	
	 int count = admin.getCount("pubs", "");
          ...
          <div class="container">
           ...
           <li class="active" class="dropdown">
                  ...
                  <ul class="dropdown-menu">
                    <li><a href="author.jsp">Author Management</a></li>
            <li><a href="book.jsp">Book Management</a></li>
            <li><a href="publisher.jsp">Publisher Management</a></li>
            <li><a href="users.jsp">Borrower Management</a></li>
            <li><a href="branchdetails.jsp">Branch Management</a></li>
            <li><a href="genre.jsp">Genre Management</a></li>
                  </ul>
                </li>
      ...
      <div class="row">
        ...
        <br>
          <ul class="nav nav-sidebar">
            <li class="active"><a href="publisher.jsp">Overview <span class="sr-only">(current)</span></a></li>
            <li><a href="addpublisher.jsp">Add publisher</a></li>
            <li><a href="viewpublisher.jsp">View publishers</a></li>
          </ul>
        </div>
